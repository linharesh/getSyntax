...
class Languages {
    ...
    init(){
        ...
        var stSWITCH = Statement(name:"Switch", image:"Objective-C-Switch", description: "int number, equals, 1; semicolon; switch ;open parenthesis; number ;close parenthesis; open curly parenthesis; case 0; colon; N S Log, open parenthesis, @, quote, zero, quote, close parenthesis, semicolon; break; semicolon; case 1; colon; N S log, open parenthesis, @, quote, one, quote, semicolon; break; semicolon; default; colon; N S log, open parenthesis, @, quote, Integer; out; of; range; quote, close parenthesis, semicolon; break; semicolon ; close curly brackets; This code logs, one")
