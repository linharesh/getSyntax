...
class CompareViewController: UIViewController,UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if (segue.identifier == "compareSegue") {
            ...
            viewController.firstLanguage = self.languagesObject.languages[self.firstLanguage.selectedRowInComponent(0)]
            
            
            //gets the name of the second language
            viewController.secondLanguage = self.languagesObject.languages[self.secondLanguage.selectedRowInComponent(0)]
            
            
            //gets the name of the statement
            viewController.StatementName = self.statements[self.statementPicker.selectedRowInComponent(0)]
